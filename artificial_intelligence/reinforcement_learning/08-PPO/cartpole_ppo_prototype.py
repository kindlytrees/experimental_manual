...
class PPO:
    ...
    def __init__(self, state_dim, hidden_dim, action_dim, actor_lr, critic_lr,
        ...
        self.critic = ValueNet(state_dim, hidden_dim).to(device) #评论员网络
    ...
    def take_action(self, state):
        ...
        action = action_dist.sample()#基于概率分布进行采样，高概率的获取的动作的概率就要高
        return action.item()
    
    def save(self, weights_path):
        torch.save(self.actor.state_dict(), weights_path)
