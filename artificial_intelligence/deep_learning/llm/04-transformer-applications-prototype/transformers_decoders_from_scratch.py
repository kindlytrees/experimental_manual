...
with open('dataset/sales_textbook.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
class TransformerLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.token_embedding_lookup_table = nn.Embedding(num_embeddings=vocab_size, embedding_dim=self.d_model)
        ...
        self.language_model_out_linear_layer = nn.Linear(in_features=self.d_model, out_features=vocab_size)
